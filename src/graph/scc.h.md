...
data:
  ...
  attributes:
    document_title: Strongly Connected Component
    links: []
  bundledCode: "#line 2 \"src/graph/scc.h\"\n\n/**\n * @file scc.h\n * @brief Strongly\
  ...
  code: "#pragma once\n\n/**\n * @file scc.h\n * @brief Strongly Connected Component\n\
    \ */\n\n#include \"digraph.h\"\n\nnamespace workspace {\n\n/**\n * @brief Strongly\
    \ connected component algorithm.\n * @return List of all components in topological\
    \ order.\n */\ntemplate <class _Attr, class _List>\nauto digraph<_Attr, _List>::scc()\
    \ const noexcept {\n  std::vector<std::vector<node_type>> __scc;\n  __scc.reserve(size());\n\
...
layout: document
redirect_from:
- /library/src/graph/scc.h
- /library/src/graph/scc.h.html

...
class Lazy_segment_tree
{
  ...
  public:
    Lazy_segment_tree(size_t _n, const Monoid &_identity,
  ...
  private:
    ...
    void eval(size_t k, size_t l, size_t r)
    {
        ...
        if(r - l > 1)
        {
            lazy_opr(lazy[left(k)], lazy[k], (r - l) >> 1);
            lazy_opr(lazy[right(k)], lazy[k], (r - l) >> 1);
    ...
    Monoid query(size_t a, size_t b, size_t k, size_t l, size_t r)
    {
        ...
        return opr(query(a, b, left(k), l, (l + r) >> 1),
                   query(a, b, right(k), (l + r) >> 1, r));
    }

...
data:
  ...
  bundledCode: "#line 2 \"string/rolling_hash.hpp\"\n#include <algorithm>\n#include\
    ...
    \    for (auto &&c : str)\n      suffix.emplace_back(\n          rolling_hashed{static_cast<rolling_hashed::u64>(c)\
  ...
  code: "#pragma once\n#include <algorithm>\n#include <cassert>\n#include <vector>\n\
    ...
    \ &rhs) const {\n    assert(!(length < rhs.length));\n    return {minus(value,\
    \ mult(rhs.value, base_pow(length - rhs.length))),\n            length - rhs.length};\n\
    \  }\n\n  static u64 base_pow(size_t exp) {\n    static std::vector<u64> pow{1};\n\
  ...
  requiredBy: []
  timestamp: '2020-09-22 16:23:43+09:00'

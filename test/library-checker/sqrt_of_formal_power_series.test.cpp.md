...
data:
  ...
  bundledCode: "#line 1 \"test/library-checker/sqrt_of_formal_power_series.test.cpp\"\
    ...
    \ __t < --__p; ++__t) *__t ^= *__p ^= *__t ^= *__p;\n  return __os << __s;\n}\n\
    \n#endif\n\n}  // namespace workspace\n#line 7 \"test/library-checker/sqrt_of_formal_power_series.test.cpp\"\
    \n\nint main() {\n  using namespace workspace;\n\n  int n;\n  cin >> n;\n  formal_power_series<modint<998244353>>\
    \ a(n);\n  cin >> a;\n  a = a.sqrt();\n  if (a.empty())\n    std::cout << \"-1\\\
    n\";\n  else {\n    a.resize(n);\n    std::cout << a << \"\\n\";\n  }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/library-checker/sqrt_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/library-checker/sqrt_of_formal_power_series.test.cpp
- /verify/test/library-checker/sqrt_of_formal_power_series.test.cpp.html

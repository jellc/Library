...
data:
  ...
  attributes:
    ...
    PROBLEM: https://old.yosupo.jp/problem/multipoint_evaluation
    links:
  ...
  bundledCode: "#line 1 \"test/library-checker/multipoint_evaluation.test.cpp\"\n\
    ...
    \ __t < --__p; ++__t) *__t ^= *__p ^= *__t ^= *__p;\n  return __os << __s;\n}\n\
    \n#endif\n\n}  // namespace workspace\n#line 7 \"test/library-checker/multipoint_evaluation.test.cpp\"\
    \n\nint main() {\n  using namespace workspace;\n  using mint = modint<998244353>;\n\
    \n  int n, m;\n  cin >> n >> m;\n  polynomial<mint> f(n);\n  std::vector<mint>\
    \ p(m);\n  cin >> f >> p;\n  f.eval(begin(p), end(p));\n  std::cout << p << \"\
    \\n\";\n}\n"
  code: "#define PROBLEM \"https://old.yosupo.jp/problem/multipoint_evaluation\"\n\
  ...
  requiredBy: []
  timestamp: '2021-08-29 00:29:14+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/library-checker/multipoint_evaluation.test.cpp
layout: document
redirect_from:
- /verify/test/library-checker/multipoint_evaluation.test.cpp
- /verify/test/library-checker/multipoint_evaluation.test.cpp.html

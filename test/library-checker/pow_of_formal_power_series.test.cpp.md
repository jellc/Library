...
data:
  ...
  bundledCode: "#line 1 \"test/library-checker/pow_of_formal_power_series.test.cpp\"\
    ...
    \ __t < --__p; ++__t) *__t ^= *__p ^= *__t ^= *__p;\n  return __os << __s;\n}\n\
    \n#endif\n\n}  // namespace workspace\n#line 7 \"test/library-checker/pow_of_formal_power_series.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/library-checker/pow_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/library-checker/pow_of_formal_power_series.test.cpp
- /verify/test/library-checker/pow_of_formal_power_series.test.cpp.html

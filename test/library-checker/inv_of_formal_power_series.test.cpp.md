...
data:
  ...
  attributes:
    ...
    PROBLEM: https://old.yosupo.jp/problem/inv_of_formal_power_series
    links:
    - https://old.yosupo.jp/problem/inv_of_formal_power_series
  bundledCode: "#line 1 \"test/library-checker/inv_of_formal_power_series.test.cpp\"\
    ...
    \ __t < --__p; ++__t) *__t ^= *__p ^= *__t ^= *__p;\n  return __os << __s;\n}\n\
    \n#endif\n\n}  // namespace workspace\n#line 7 \"test/library-checker/inv_of_formal_power_series.test.cpp\"\
    \n\nint main() {\n  using namespace workspace;\n\n  int n;\n  cin >> n;\n  polynomial<modint<998244353>>\
    \ a(n);\n  cin >> a;\n  std::cout << a.inv() << \"\\n\";\n}\n"
  code: "#define PROBLEM \"https://old.yosupo.jp/problem/inv_of_formal_power_series\"\
  ...
  requiredBy: []
  timestamp: '2022-04-06 16:08:51+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/library-checker/inv_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/library-checker/inv_of_formal_power_series.test.cpp
- /verify/test/library-checker/inv_of_formal_power_series.test.cpp.html

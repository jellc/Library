...
data:
  ...
  bundledCode: "#line 1 \"test/aizu-online-judge/GRL_2_A.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/GRL_2_A\"\n\n#include <iostream>\n\
    ...
    }  // namespace workspace\n#line 6 \"test/aizu-online-judge/GRL_2_A.test.cpp\"\
    \n\nint main() {\n  size_t n, m, s, t;\n  uint64_t w;\n  std::cin >> n >> m;\n\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/GRL_2_A\"\n\n\
    ...
    \ n, m, s, t;\n  uint64_t w;\n  std::cin >> n >> m;\n\n  workspace::weighted_graph<uint64_t>\
    \ g(n);\n  while (m--) {\n    std::cin >> s >> t >> w;\n    g.add_edge(s, t, w);\n\
  ...
  verifiedWith: []
documentation_of: test/aizu-online-judge/GRL_2_A.test.cpp
layout: document
redirect_from:
- /verify/test/aizu-online-judge/GRL_2_A.test.cpp
- /verify/test/aizu-online-judge/GRL_2_A.test.cpp.html
